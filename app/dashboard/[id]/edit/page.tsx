  ...
  if (!selectedCourse) {
    return (
      <div className=" px-5 flex items-center justify-center text-center my-20">
        <h1 className="my-5font-medium text-sm md:text-xl max-w-xs mx-auto md:w-full">Course with id
          ...
          <div className="order-1">
            <Tabs defaultValue="course" className="">
              <TabsList className="max-w-2xl grid grid-cols-4">
                ...
                <TabsTrigger className="cursor-pointer border" value="reorder">Reorder</TabsTrigger>
              </TabsList>
            ...
            <AccordionContent className="px-5 pb-5">
              {selectedCourse.Module.length > 0 ? (
                <Accordion type="multiple" className="space-y-3 mt-2">
                  {selectedCourse.Module.sort((a, b) => a.order - b.order).map(
                    (module, idx) => (
                      <AccordionItem
                        key={module.id}
                        value={module.id}
